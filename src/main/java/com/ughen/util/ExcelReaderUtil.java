...
import com.ughen.util.excl.Excel2003Reader;
import com.ughen.util.excl.Excel2007Reader;
import com.ughen.util.excl.IRowReader;
...
public final class ExcelReaderUtil {
    ...
    public static void main(String[] args) throws Exception {
        List<String[]> strings = excelToArrayList("D:\\opt\\test.xls");
